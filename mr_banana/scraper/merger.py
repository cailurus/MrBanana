...
from .text_utils import (
    derive_dmm_artwork as _derive_dmm_artwork,
    looks_bad_plot as _looks_bad_plot,
    looks_meta_plot as _looks_meta_plot,
    looks_placeholder_plot as _looks_placeholder_plot,
)
